<?php
	...
	$listeCours=$coursFitGroup->find(array('conditions'=>'date BETWEEN \''.$dateDebSemaine.'\' AND \''.$dateFinSemaine.'\''));
 	...
 	$tableauCalendrier= creationCalendrier($dateDebSemaine,$dateFinSemaine,$listeCours,$typeFitGroup);
	...
	$lesDifferentsFitGroup=$typeFitGroup->find(array('fields'=>'id, nom, nbPlace','conditions'=>'affichage=1'));
