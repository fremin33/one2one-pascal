...
<div class="wrapper">
  ...
  <div id="corps">
     <article>
     <?php include('contenus/inscrireClientCrossTraining/controller.php'); // Inclure la page ?>
    </article> 
...
<script type="text/javascript" src="calendrierCrossTraining/inscription/inscriptionCalendrier.js"></script>
