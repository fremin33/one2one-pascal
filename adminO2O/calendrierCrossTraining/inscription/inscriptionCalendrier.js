	...
	$('#desinscriptionCours').click(function(event)
		{
			...
			$.ajax(
				...
				{
					url:"calendrierCrossTraining/inscription/desinscriptionBd.php",
		    		...
		    		dataType : "json",
					 success: function(data) {
								...
								if(data.contenuMail!="")
		   				{
		   					...
		   					$.post("calendrierCrossTraining/inscription/mailAEnvoyer.php",{dest:data.adresseMail,message:data.contenuMail});
...
/*******************************/
	...
	$('#inscriptionCours').click(function(event){
			...
			$.ajax(
				{
					url: "calendrierCrossTraining/inscription/inscriptionBd.php",
					data: $("#inscriptionCoursFitGroup").serialize(),
					type    : "GET",
		    		dataType : "json",
					 success: function(data) {
...
function survol(e)
{
	...
	$.ajax(
				{
					url: "calendrierCrossTraining/listeClient/affichageReservations.php",
					data: {id:e},
					type    : "GET",
		    		//dataType : "json",
					 success: function(data) {
