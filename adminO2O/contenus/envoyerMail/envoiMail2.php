...
function envoyerUnMail($destinataire,$message, $fichierJoint=null, $fichierJointPDF=null)
{
	$mail = $destinataire;
...
$fichier   = fopen($fichierJoint, "r");
$attachement = fread($fichier, filesize($fichierJoint));
...
//=====Définition du sujet.
$sujet = "One 2 One : Soirée nutrition";
//=========
...
$message.= "Content-Type: image/jpeg; name=\"".$fichierJoint."\"".$passage_ligne;
