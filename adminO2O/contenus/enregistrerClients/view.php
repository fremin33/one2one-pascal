...
if($okAbonnementCrossTraining===true) {if($_POST['nbSeanceCrossTraining']>1) $seance="séances"; else $seance="séance";
		$rep.="<li>  une adhésion CROSS TRAINING de ".$_POST['nbSeanceCrossTraining']." ".$seance." valable jusqu'au <span class=\"rose\">".$_POST['dateCrossTraining']."</span></li>";}




if($okAbonnementCarte===true) {if($_POST['nbSeanceCarte']>1) $seance="séances"; else $seance="séance";
		$rep.="<li>  une adhésion FIT GROUP - CROSS TRAINING de ".$_POST['nbSeanceCarte']." ".$seance." valable jusqu'au <span class=\"rose\">".$_POST['dateFitCarte']."</span></li>";}
