        ...
        <table class="tableauLesCours">	
            ...
            <!--Creation du cours CROSS TRAINING-->
        	   ...
        	   <!--<tr><td class="drop">
                ...
                <?php foreach ($lesDifferentsCrossTraining as $key => $value) :?>
				<?php $nom=explode(' ',$value['nom']); ?>
				<tr><td class="drop"><div class="item"><p id="idFit"><?php echo $value['id']; ?></p><p><?php echo $nom[0]; ?></p><p><?php echo $nom[1]." ".$nom[2]; ?></p><p><?php if(isset($nom[3])) echo $nom[3];?></p><p class="nbPlace"><?php echo $value['nbPlace']; ?></p></div></td></tr>
