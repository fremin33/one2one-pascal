<?php
	...
	$listeCours=$coursCrossTraining->find();
	...
	$listeCours=$coursCrossTraining->find(array('conditions'=>'date BETWEEN \''.$dateDebSemaine.'\' AND \''.$dateFinSemaine.'\''));
 	...
 	$tableauCalendrier= creationCalendrier($dateDebSemaine,$dateFinSemaine,$listeCours,$typeCrossTraining);
	...
	$lesDifferentsCrossTraining=$typeCrossTraining->find(array('fields'=>'id, nom, nbPlace','order'=>'id'));
