...
function creationCalendrier ($dateDebSemaine,$dateFinSemaine,$listeCours,$typeFitGroup) {
    ...
    {
        $plageH = array('09:00:00','12:30:00','15:30:00', '17:30:00', '18:40:00','19:45:00');
    }
    else{
    ...
    {
        if(($num_week<23)&& $anneeDebut==2016)   
            $plageH = array('12:30:00','13:30:00', '14:30:00', '15:30:00', '16:30:00', '17:30:00', '18:30:00','19:30:00');
        else
            if((($num_week>=24)&& $anneeDebut==2016) || $anneeDebut>=2017  )
                  $plageH = array('12:30:00','13:30:00', '15:30:00', '17:30:00', '18:40:00','19:45:00');
            else
            
            $plageH = array('12:30:00','13:30:00', '15:30:00', '17:30:00', '18:30:00','19:30:00');
    }
	}
	            ...
	            for ($j = 0; $j < 7; $j++)
	            {
					...
					foreach ($listeCours as $key => $value) 
					{
						...
						if($dateHeure===$id)
						{
							...
							if(($typeFitGroup!=null) && $value['idTypeCrossTraining']!=0) 
                            {
                                $cours=$typeFitGroup->find(array(
											"fields"=>'id, nom',
											"conditions"=>'id='.$value['idTypeCrossTraining']));	
							...
							if (sizeof($nom) === 4) {
								$contenu.= '
								<p style="text-align:center;color:red;text-decoration:underline;">'.$nom[3].'</p>'; $contenu.= '
								<p>'.$nom[0].'</p>'; $contenu.= '
								<p>'.$nom[1].' '.$nom[2].'</p>';
							} else {
                                $contenu.= '<p>'.$nom[0].'</p>';
