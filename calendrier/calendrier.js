...
$('.tableauLesCours td.drop').droppable({
    ...
    onDrop:function(e,source){
       ...
       $(source).remove();
        ...
        $.post("calendrier/suppresionBdFitGroup.php",{'id':idCours},function(data)
        {
        	alert(data);
        });
...
$.post("calendrier/enregistrementBdFitGroup.php", $("#enregistementCoursFitGroup").serialize(),  function(data) {
  alert(data);
